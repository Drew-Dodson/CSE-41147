 ...
 */
print(userAge)
// userAge cannot be assigned a value and userInputAge has a compiler error so it does not have a value because "34e" cannot be converted to an Int
/*:
 ...
 */
// It labels it as an optional as we have not properly unwrapped it
print(userAge!)
/*:
 Now use optional binding to unwrap `userAge`. If `userAge` has a value, print it to the console.
 */
if let newUserAge = userAge {
    print(newUserAge)
}
