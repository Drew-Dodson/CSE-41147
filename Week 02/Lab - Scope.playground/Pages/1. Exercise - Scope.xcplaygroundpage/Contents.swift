...
//ANSWER:
print("the variable 'foo' is only available in the for loop as that is where it was declared.")
/*:
...
//ANSWER:
print("X is declared outside of the for loop there for it can be references both inside the loop and outside the loop. The variable 'x' is declaed outside of the loop is modified inside the loop where foo was declared inside the loop but then referenced outside the loop.")
/*:
...
greeting(greeting: "Welcome to the Jungle", name: "Axel")
